...
// alTimewax //
module.exports.handleDescription = function (e, vueComponentPrototype) {
  const description = vueComponentPrototype.description
  const text = !description || description.length === 0 ? 'No description to display.' : description

  e.doclet.description += `<h3 class="subsection-title">Description</h3><p>${ text }</p>`
}
////
